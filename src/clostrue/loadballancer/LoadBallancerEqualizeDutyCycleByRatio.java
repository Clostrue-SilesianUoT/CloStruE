 ...
 */
public class LoadBallancerEqualizeDutyCycleByRatio extends LoadBallancerEmpty implements LoadBallancer{
   
    private static boolean LOG_TO_CONSOLE = false;
    private static boolean WITHOUT_GAIN = false;
    
    public LoadBallancerEqualizeDutyCycleByRatio(Simulation inSimulation) {
        super(inSimulation, "Equalize DutyCycles By Ratio without Gain",LOG_TO_CONSOLE);
    }
