 ...
 */
public class LoadBallancerEqualizeDutyCycleBySubtractionWithGain extends LoadBallancerEmpty implements LoadBallancer{
   
    private static boolean LOG_TO_CONSOLE = false;
    private static boolean WITH_GAIN = true;
    
    public LoadBallancerEqualizeDutyCycleBySubtractionWithGain(Simulation inSimulation) {
        super(inSimulation, "Equalize DutyCycles By Subtraction with Gain",LOG_TO_CONSOLE);
    }
