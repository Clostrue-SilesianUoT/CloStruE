 ...
 */
public class LoadBallancerEqualizeCellCountWithGain extends LoadBallancerEmpty implements LoadBallancer{
   
    private static boolean LOG_TO_CONSOLE = false;
    private static boolean WITH_GAIN = true;
    
    public LoadBallancerEqualizeCellCountWithGain(Simulation inSimulation) {
        super(inSimulation, "Equalize CellCount With Gain",LOG_TO_CONSOLE);
    }
...
// do the load ballancing
    ...
    public void ballanceWork() {
        ...
        ArrayList<TaskMeasure> measures = prepareMeasuresBasedOnCellCount(WITH_GAIN);
